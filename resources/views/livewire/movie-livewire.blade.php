                ...
                <div class="card-body">
                    <form method="GET" action="{{ url('/movie') }}">
                        <div class="row">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row ">
                                                    <div class="col-sm-3">
                                                        <input wire:model="priceMin" type="number" name="priceMin" min="0" class="form-control" required />
                                                    </div>
                                                    <div class="col-sm-1 text-center">
                                                        -
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <input wire:model="priceMax" type="number" name="priceMax" min="0" class="form-control" required />
                                                    </div>
                                                </div>
                                                <br />
                                                <h5>หมวดหมู่</h5>
                                                <div class="row ">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-check">
                                                            <input wire:model="category_ids" class="form-check-input" type="checkbox" value="{{ $c->id }}" name="category_ids[]">
                            ...
                            <div class="col-lg-3">
                                <select wire:model="sort" class="form-select" name="sort" id="sort">
                            ...
                            <div class="col-lg-3">
                                <div class="input-group">
                                    <input wire:model="keyword" type="text" class="form-control" name="search" placeholder="Search..." />
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('/movie/' . $item->id . '/edit') }}" title="Edit Movie"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                Edit</button></a>

                                        <form method="POST" action="{{ url('/movie' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                            {{ method_field('DELETE') }}
                                            {{ csrf_field() }}
                                            <button type="submit" class="btn btn-danger btn-sm" title="Delete Movie" onclick="return confirm('Confirm delete?')"><i class="fa fa-trash-o" aria-hidden="true"></i>
                                                Delete</button>
                                        </form>
                                    </td>
                                </tr>
