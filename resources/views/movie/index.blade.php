                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-sm-3">
                                                            <input type="number" name="priceMin" min="0" value="{{ request('priceMin') ? request('priceMin') : '0' }}" class="form-control" required />
                                                        </div>
                                                        <div class="col-sm-1 text-center">
                                                            -
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <input type="number" name="priceMax" min="0" value="{{ request('priceMax') ? request('priceMax') : '10000' }}" class="form-control" required />
                                                        </div>
                                                    </div>
                                                    <br />
                                                    <h5>หมวดหมู่</h5>
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox" value="{{ $c->id }}" name="category_ids[]" {{ in_array($loop->iteration, request('category_ids',[])) ? "checked" : "" }}>
